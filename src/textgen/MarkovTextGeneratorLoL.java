	...
	public void train(String sourceText)
	{
		...
		for(String word: words){
			...
			for (int i=0; i<wordListSize; i++){
			    curListNode = wordList.get(i);
			    if(curListNode.getWord().equalsIgnoreCase(starter)){
			    	// starter is a node in the list
			    	isExist = true;
			    	break;
			    }
			}
